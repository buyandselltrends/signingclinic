...
<main class="pt-24 pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen">
      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            ...
            <span class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-300">Team Management</span>
          </div>
        </li>
      </ol>
    </nav>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-8 md:p-12">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">Team Management</h1>
        ...
        <?php endwhile; else: ?>
            <p class="text-gray-500 dark:text-gray-400">Content for Team Management is coming soon.</p>
        <?php endif; ?>
    </div>
</main>
